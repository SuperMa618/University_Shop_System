...
public class EmailUtil {
	...
	// 发件人用户名、密码
	private String SEND_USER = "1937951405@qq.com";
	private String SEND_UNAME = "1937951405";
	private String SEND_PWD = "dqjecmewtbancghb";
	// 建立会话
	...
	public String text(String newPwd) {
		String text = "新生报到系统重置密码" + ",您的密码重置为：" + newPwd + ",为账号安全尽快修改改密码。";
		return text;
	...
	public static void main(String[] args) {
		...
		se.doSendHtmlEmail("主题xxx", "内容xxx", "2419779749@qq.com");
	}
}
